...
import { ModalsDefaultComponent } from './modals-default.component';

@Component({
    template: `
        <sbpro-modals-default
            [someInput]="someInput"
...
describe('ModalsDefaultComponent', () => {
    let fixture: ComponentFixture<TestHostComponent>;
    let hostComponent: TestHostComponent;
    let hostComponentDE: DebugElement;
    let hostComponentNE: Element;

    let component: ModalsDefaultComponent;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, ModalsDefaultComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sbpro-modals-default')).toEqual(jasmine.anything());
    });
