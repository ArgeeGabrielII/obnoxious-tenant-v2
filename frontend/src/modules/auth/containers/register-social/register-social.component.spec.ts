...
@Component({
    template: ` <sbpro-register-social></sbpro-register-social> `,
})
...
describe('RegisterSocialComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, RegisterSocialComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sbpro-register-social')).toEqual(jasmine.anything());
    });
    it('should submit if valid', () => {
        ...
        component.termsAndConditionsControl.setValue(true);
        component.onSubmit();
    ...
    it('should return termsAndConditionsControlValid', () => {
        expect(component.termsAndConditionsControlValid).toBe(false);

        component.termsAndConditionsControl.markAsTouched();
        component.termsAndConditionsControl.setValue(true);
        expect(component.termsAndConditionsControlValid).toBe(true);
    });
    it('should return termsAndConditionsControlInvalid', () => {
        component.termsAndConditionsControl.markAsTouched();
        expect(component.termsAndConditionsControlInvalid).toBe(true);
    });
});
