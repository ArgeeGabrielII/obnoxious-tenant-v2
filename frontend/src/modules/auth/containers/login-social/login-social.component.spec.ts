...
@Component({
    template: ` <sbpro-login-social></sbpro-login-social> `,
})
...
describe('LoginSocialComponent', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [TestHostComponent, LoginSocialComponent],
    ...
    it('should display the component', () => {
        expect(hostComponentNE.querySelector('sbpro-login-social')).toEqual(jasmine.anything());
    });
